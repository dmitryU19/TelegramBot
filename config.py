...
message_library = {
    "start_message": "Вітаємо! Ви звернулися до системи обслуговувавння абонентів.",
    ...
    "main_menu": "Чи Вам допомогти (напишіть номер розділу меню):\n"
                 "1 - Оформити заявку\n"
                 "2 - Статус заявки\n"
                 "3 - Тарифний план\n"
                 "4 - Баланс\n",
    ...
    "network_type": "Вкажіть стандарт мобільної мережі:",
